...
function drawText() {
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "and yet here I am to get the impossible chance to get to be with you",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 2700 && frameNumber < 3000) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "and yet here I am to get the impossible chance to get to with you",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Will You Be Mine?(You are MINE already)",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
